                        ...
                        marker.getElement().addEventListener('click', function() {
                            ...
                            navigator.clipboard.writeText(location.telefono)
                                .then(() => {
                                    ...
                                    alert('Número copiado al portapapeles: ' + location.telefono);

                                    // Enviar a la base de datos el ID del usuario y el último ID de emergencia
                                    if (lastEmergencyId) {
                                        fetch('save_user_emergency.php', {
                                            method: 'POST',
                                            headers: {
                                                'Content-Type': 'application/json'
                                            },
                                            body: JSON.stringify({
                                                usuario_id: location.usuario_id,
                                                emergency_id: lastEmergencyId
                                            })
                                        })
                                        .then(response => response.json())
                                        .then(result => {
